#
#  Be sure to run `pod spec lint SPDevKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = "Superwave"
  # Or just: s.author    = "superwave"
  # s.authors            = { "superwave" => "superwave0705@gmail.com" }
  # s.social_media_url   = "http://twitter.com/superwave"
  ...
  s.source       = { :git => "https://github.com/superwave/SPDevKit.git", :tag => s.version.to_s }
