...
+(NSString *)randomStringWithTypes:(NSArray *)types length:(int)length{
    ...
    for(id type in types){
        switch ([type intValue]) {
            case SPTestStrTypeEngLower:
                baseString = [NSString stringWithFormat:@"%@%@",baseString,EnUpper];
                break;
            case SPTestStrTypeEngUpper:
                baseString = [NSString stringWithFormat:@"%@%@",baseString,EnLower];
                break;
            case SPTestStrTypeNum:
                baseString = [NSString stringWithFormat:@"%@%@",baseString,Num];
                break;
            case SPTestStrTypeZn:
                baseString = [NSString stringWithFormat:@"%@%@",baseString,Zn];
                break;
            default:
                break;
        }
    }
    return [self generateRandomStringWithBase:baseString length:length];
}
...
+(NSString *)imageUrlWithPlaceholdit:(int)width height:(int)height{
    return [NSString stringWithFormat:@"http://placehold.it/%dx%d",width,height];
}
@end
